...
urlpatterns = [
    ...
    path('courses/<int:pk>/detail/', views.CourseDetailView.as_view(), name='courses_list_detail'),
    path('courses/feedback/', views.CourseFeedbackCreateView.as_view(), name='courses_list_feedback'),
